            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6" id="pedikura">
                <div class="box">
                    ...
                    <div class="info">
                        ...
                        <p>Pedikura je nega nog in nohtov. Naša stopala je treba negovati skozi vse leto. Pomembno je
                            sprotno in pravilno striženje nohtov. Vse več nas ima težave s kurjimi očesi in otiščanci,
                            ki so večinoma posledica nepravilne obutve, udarcev ali dolgotrajnega stoječega dela.
                            Vse težave saniramo s steriliziranim orodjem, za konec pa stopalom privoščimo še kratko
                            masažo s primerno kremo.</p>
                    </div>
                </div>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6" id="nega-obraza">
                <div class="box">
                    ...
                    <div class="info">
                        ...
                        <p>V današnjem času, ko smo vsakodnevno izpostavljeni zunanjim vplivom, kot so umazano ozračje,
                            vročina ali mraz, je treba še bolje poskrbeti za kožo na obrazu, saj je najbolj izpostavljen
                            del telesa. V porah na obrazu se dnevno kopiči umazanija, ki se nabira znotraj kože ob
                            procesu samodejnega čiščenja kože in umazanija, ki jo »prejmemo« iz zraka, ki nas obdaja.
                            Zato je potrebno pore čistiti, saj se lahko zamašene pore tudi vnamejo.
                            Pri negi kožo najprej površinsko očistimo in jo analiziramo, nato uporabimo piling, da s
                            kože odstranimo nečistoče in odmrlo kožo, nato nadaljujemo z globinskim čiščenjem kože. Po
                            globinskem čiščenju uporabimo masko, primerno tipu kože, s katero kožo pomirimo. Za konec
                            masiramo obraz s kremo, primerno tipu kože stranke.

                            V našem salonu nudimo dve vrsti nege obraza in dekolteja; osnovno in specialno – z ampulami
                            Vita derma, kozmetike Afrodita. Obe vrsti nege izvajamo s kozmetiko Afrodita. Pri negi
                            obraza uredimo tudi obrvi, po potrebi pobarvamo tako obrvi kot trepalnice.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6" id="depilacija">
                <div class="box">
                    ...
                    <div class="info">
                        ...
                        <p>Depilacija je postopek začasnega odstranjevanja odvečnih dlak z določenega dela telesa ali
                            obraza. Ljudje se za depilacijo odločamo bodisi zaradi estetskega videza bodisi zaradi
                            lažjega vzdrževanja higiene.
                            V kozmetičnem salonu Deja izvajamo depilacijo z vročim voskom in trakovi, s katerimi
                            odstranimo nadležne dlačice.</p>
                    </div>
                </div>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6" id="wax">
                <div class="box">
                    ...
                    <div class="info">
                        ...
                        <p>Brazilska ali intimna depilacija je postopek odstranjevanja dlak na predelu bikinija,
                            venerinega hribčka, sramnih ustnic in anusa. To vrsto depilacije izvajamo s posebnim voskom
                            za občutljive cone telesa. Prednost brazilske (intimne) depilacije so predvsem higiena,
                            gladka in mehka koža ter posledično tudi počasnejša in redkejša rast dlak. Odstranjene dlake
                            ponovno zrastejo v 2 - 3 tednih. Z omenjeno depilacijo se izognemo tudi neprijetnim
                            posledicam: srbečica, razdraženost.</p>
                    </div>
                </div>
            </div>
